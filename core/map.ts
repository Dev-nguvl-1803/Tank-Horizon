...
// Define the interface for a board tile
interface BoardTile {
    row: number;
    col: number;
    top: boolean;
...
const generateBoard = (): BoardTile[] => {
    let board: BoardTile[] = [] //tạo bảng
    let k: number = 0 //cho chỉ mục khóa
...
const printBoard = (board: BoardTile[]): void => { //in toàn bộ bảng
...
const tokens: string[] = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890".split("")
